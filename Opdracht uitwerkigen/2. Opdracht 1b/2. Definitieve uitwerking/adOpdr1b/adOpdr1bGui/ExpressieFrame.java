  ...
  private void berekenKnopAction() {
    // Voeg hier eigen code toe
      ...
      try {
        ...
        waardeVeld.setText(String.valueOf(PostfixCalc.calcPostfixExpressie(expressieVeld.getText())));
      }
      catch (PostfixException | IOException e1) {
        // Toon een eventuele foutmelding van de methode calcPostfixExpressie in het foutLabel
